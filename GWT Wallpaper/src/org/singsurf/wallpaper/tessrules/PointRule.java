                ...
                try
                {
                    if(srcX<0 || srcX>=dr.srcRect.width || srcY<0 || srcY>=dr.srcRect.height) {
                        if(TessRule.tileBackground) {
                            ...
                            int outInd = 4*(i+j*dr.destRect.width);
                            int inInd = 4*(srcX+srcY*dr.srcRect.width);
                        ...
                        int outInd = 4*(i+j*dr.destRect.width);
                        int inInd = 4*(srcX+srcY*dr.srcRect.width);
    		            int px_r = dr.inCPA.get(inInd);
    		            int px_g = dr.inCPA.get(inInd+1);
    		            int px_b = dr.inCPA.get(inInd+2);
    		            int px_a = dr.inCPA.get(inInd+3);
