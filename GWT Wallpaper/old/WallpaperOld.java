...
public class WallpaperOld extends JPanel implements MouseListener, MouseMotionListener, KeyListener, ItemListener
{
...
//    } 
    ...
    protected JComboBox buildAnimationChoice() {
	    //stopBut.setVisible(true);
	    //stopBut.setEnabled(false);
	
	    animateChoice = new JComboBox();
